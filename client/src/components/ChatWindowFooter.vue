<template>
  <div class="pb-6 px-4">
    <!-- <div class="flex rounded-lg border-2 border-grey overflow-hidden">
      ...
      <input type="text" class="w-full px-4" :placeholder="'Message ' + channel" />
    </div> -->
    <input type="text" class="w-full rounded-lg border-2 border-grey overflow-hidden py-2 px-4" :placeholder="'Message ' + channel" />
  </div>
</template>
